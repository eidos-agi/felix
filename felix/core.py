...
def render_agent_interview(name: str, purpose: str = "") -> str:
    ...
    lines = [
        ...
        "13. What wiki/task memory should be substrate before the LLM thinks?",
        "14. What brand-safety, secret-safety, finance/legal, or domain-specific gates apply?",
        "",
        "Scaffold decision",
        "15. Is this only a narrow embedded project tool, or a durable agent role that deserves its own repo?",
        "16. What CLI verbs should exist on day one?",
        "17. What files should be generated beyond the Felix defaults?",
        "18. What done proof shows this agent is not just a wrapper around another agent's responsibility?",
        "",
